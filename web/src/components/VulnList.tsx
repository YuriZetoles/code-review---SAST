    ...
    <div>
      ...
      {filtered.length === 0 && (
        <div className="text-center py-12">
          <svg className="w-10 h-10 text-slate-700 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <p className="text-slate-500 text-sm font-code">nenhuma vulnerabilidade encontrada</p>
        </div>
      )}
                ...
                <div className="px-4 pb-4 pt-1 border-t border-slate-800/40 space-y-2">
                  {v.location && (
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-xs font-code text-slate-400 break-all">{v.location}</span>
                    </div>
                  )}
                  {v.description && (
                  ...
                  {v.fix_available && (
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <span className="text-sm text-green-400 font-code">fix: {v.fix_available}</span>
                    </div>
                  )}
                </div>
              )}
